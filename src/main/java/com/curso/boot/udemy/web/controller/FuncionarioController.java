...
import com.curso.boot.udemy.web.validator.FuncionarioValidator;
...
public class FuncionarioController {
	...
	public String getPorCargo(@RequestParam("idCargo") Long idCargo, ModelMap model) {
		model.addAttribute("funcionarios", funcionarioService.buscarPorCargo(idCargo));
		return "/funcionario/lista";
	}
